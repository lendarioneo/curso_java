...
public class Seller implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return getId().equals(seller.getId()) &&
                getName().equals(seller.getName()) &&
                getEmail().equals(seller.getEmail()) &&
                getBirthDate().equals(seller.getBirthDate()) &&
                getBaseSalary().equals(seller.getBaseSalary()) &&
                getDepartment().equals(seller.getDepartment());
    }
